...
using WAD_NguyenDucAnh.Models;
using PagedList;

namespace WAD_NguyenDucAnh.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            switch (sortOrder)
            {
                ...
                default:
                    products = (DbSet<Product>)products.OrderBy(s => s.Name);
                    break;
            }
            int pageSize = 3;
            int pageNumber = (page ?? 1);
            //var x = products.Include("Category");
            return View(products.Include("Category").ToPagedList(pageNumber, pageSize));
        }
