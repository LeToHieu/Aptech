...
namespace DependencyResolver.Infra
{
    internal class DropCreateDBOnModelChanged : DropCreateDatabaseAlways<SchoolContext>
    {
        ...
        protected override void Seed(SchoolContext context)
        {
            ...
            List<string> CourseNames = new List<string>() {"WCF", "WFP", "ASP.NET", "Advanced .Net", ".Net Performance", "LINQ", "Entity Framework", "Windows Azure", "Windows Phone 8", "Production Debugging"};
