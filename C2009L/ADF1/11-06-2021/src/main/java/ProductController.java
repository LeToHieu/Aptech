...
public class ProductController {
    ...
    public void openUrl() {
        System.setProperty("webdriver.chrome.driver", "/Users/nguyenduchoang/Documents/chromedriver");
        WebDriver driver = new ChromeDriver();
        WebDriverWait wait = new WebDriverWait(driver, 5L);
        try {
            driver.get(this.getUrl(1));
            String xPath = "//div[@class='s-main-slot s-result-list s-search-results sg-row']/div/div";
            ...
            for (WebElement eachElement: elements) {
                ...
                String url = eachElement.findElement(By.xpath("//img[@class='s-image']")).getAttribute("src");
