...
namespace Exam2.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            {
                products = products.Where(eachProduct => eachProduct.Name.Contains(searchString));
            }
            switch (sortOrder)
            {
                case "name_desc":
                    products = products.OrderByDescending(eachProduct => eachProduct.Name);
                    break;
                case "Date":
                    products = products.OrderBy(eachProduct => eachProduct.Price);
                    break;
                case "price_desc":
