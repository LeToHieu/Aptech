                ...
                tableRow.setOnMouseClicked(mouseEvent -> {
                    if(mouseEvent.getClickCount() == 2 && !tableRow.isEmpty()) {
                        ...
                        menuItemEdit.setOnAction(actionEvent -> {
                            ...
                            Product selectedProduct = (Product)tableRow.getItem();
                            ProductDetailScene productDetailScene = new ProductDetailScene(new VBox(), selectedProduct);
                            ((Stage)ProductsScene.this.getWindow()).setScene(productDetailScene);
                        });
                    }
                });
                return tableRow;
