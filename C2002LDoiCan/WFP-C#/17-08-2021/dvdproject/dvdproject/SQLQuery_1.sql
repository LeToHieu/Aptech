...
CREATE TABLE tblDVDCategory(
    DVDCategoryId INT IDENTITY(1, 1) PRIMARY KEY,
    CategoryName NVARCHAR(200) UNIQUE
);
CREATE TABLE tblDVDLibrary(
    DVDCodeNo INT IDENTITY(1, 1) PRIMARY KEY,
    DVDCategoryId INT,
    DVDTitle NVARCHAR(200),
    SubTitles bit,
    Price MONEY,
    DateAdd DATETIME 
);
ALTER TABLE tblDVDLibrary
ADD CONSTRAINT FK_DVDLibraryCategory
FOREIGN KEY (DVDCategoryId) REFERENCES tblDVDCategory(DVDCategoryId);

SELECT * FROM tblDVDCategory;
INSERT INTO tblDVDCategory(CategoryName)
VALUES('Dot net'),
('Java');

INSERT INTO tblDVDLibrary(DVDCategoryId, DVDTitle, SubTitles, Price, DateAdd) 
VALUES(1, 'Learn C# in 24 hours', 1, 121, '2012/12/29'),
(1, N'What''s news in C# 9', 0, 222, '2014/06/06'),
(2, N'Java 8 and JAVAFX', 1, 333, '2015/08/07'),
(2, N'Kotlin and Java', 0, 444, '2017/09/08');
